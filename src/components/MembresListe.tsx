...
import { addMembre, getFamilles, getMembres, updateMembre } from '@/lib/local-store';
...
export default function MembresListe() {
  ...
  const refresh = () => setMembres(getMembres());
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-6">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <h1 className="text-xl font-semibold text-gray-900">Gérer les membres</h1>
      </div>
